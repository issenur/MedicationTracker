  ...
  <div class="login-box-body justify-content-center" >
    ...
    <form action="../../DoctorDashboard.php" method="post">
      ...
      <div class="row d-flex justify-content-center">
        ...
        <!-- /.col -->
        <div class="col-xs-4 ">
          <button type="submit" name="button-login" class="btn btn-primary btn-block btn-flat">Sign In</button>
    ...
    <a href="?link=1" name="link1" class="text-center" >Click Here To Login As Admin</a>
    ...
    <?php
        ...
        if(isset($_GET['link'])){
            $link=$_GET['link'];
            if ($link == '1'){
                $controller->changeView("AdminLoginView");
            }
        }
    ?>  
